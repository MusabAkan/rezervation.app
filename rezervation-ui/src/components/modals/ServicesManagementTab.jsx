...
export default function ServicesManagementTab({ t, services, onSaveService, business }) {
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent>
                                            ...
                                            <DropdownMenuItem onClick={() => onSaveService(business.id, {...service, active: !service.active})}>
                                                ...
                                                {service.active ? t.deactivateService : t.activateService}
                                            </DropdownMenuItem>
                                            <DropdownMenuSeparator />
                                            <DropdownMenuItem className="text-red-500"><Trash2 className="mr-2 h-4 w-4"/> {t.delete}</DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                </div>
                             </div>
