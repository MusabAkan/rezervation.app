...
                        <div className="mt-2 flex justify-center"><Stars value={rating} setValue={setRating} interactive={true} /></div>
                    </div>
                    <div>
...
                    <Button onClick={handleSubmit} className="bg-primary hover:bg-primary/90" disabled={rating === 0}>{t.submitReview}</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    );
