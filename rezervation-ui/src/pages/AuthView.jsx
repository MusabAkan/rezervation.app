...
export default function AuthView({ t, onLogin }) {
        ...
        {step === 'selectType' ? (
            <Card className="border-0 shadow-none">
                ...
                <CardContent className="grid grid-cols-2 gap-4 py-4">
                    <Card onClick={() => handleSelectType('customer')} className="pt-6 cursor-pointer hover:bg-accent transition-colors">
                        <CardContent className="text-center">
                            <User size={48} className="mx-auto mb-2 text-primary" />
                            <p className="font-semibold">{t.customer}</p>
                        </CardContent>
                    </Card>
                    <Card onClick={() => handleSelectType('business')} className="pt-6 cursor-pointer hover:bg-accent transition-colors">
                        <CardContent className="text-center">
                        ...
                        <TabsContent value="register" className="space-y-3 pt-4">
                            ...
                            <div className="items-top flex space-x-2 pt-2">
                                ...
                                <div className="grid gap-1.5 leading-none">
                                    <label htmlFor="terms-modal" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">{t.agreeToTerms}</label>
                                </div>
                            </div>
