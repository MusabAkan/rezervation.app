...
import ServicesManagementTab from '../components/business/ServicesManagementTab';

function Stat({ label, value }) {
  return (
    <div className="p-4 rounded-lg border bg-slate-50 dark:bg-slate-800/50 dark:border-slate-700">
...
function BusinessDashboardPage({ t, currentUser, appointments, onUpdateStatus, services, onSaveService, onArrivalStatus, business }) {
