...
export default function Notifications({t, notifications, onMarkAllRead}) {
    ...
    const NotificationItem = ({notification}) => (
        <a href={notification.link}
           className="block p-4 border-b dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
            ...
            <Card>
                <Tabs defaultValue="unread">
                    <TabsList className="grid w-full grid-cols-2">
                        <TabsTrigger
                            value="unread">{t.unread} {unreadNotifications.length > 0 && `(${unreadNotifications.length})`}</TabsTrigger>
