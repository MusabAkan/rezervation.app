...
                        <Input value={newPost} onChange={(e) => setNewPost(e.target.value)} placeholder={t.postQuestion} />
                ...
                <Card>
                  <CardHeader>
                      <div className="flex items-center gap-2">
                          <Badge variant={post.type === 'business' ? 'default' : 'secondary'} className={post.type === 'business' ? 'bg-primary' : ''}>
                  ...
                  <CardContent>
                      ...
                      <div className="flex items-center gap-4 text-sm text-slate-500">
                          <Button variant="ghost" size="sm" className="gap-2"><ThumbsUp className="h-4 w-4" /> {post.likes}</Button>
                          <Button variant="ghost" size="sm" className="gap-2"><MessageCircleMore className="h-4 w-4" /> {post.replies} Yanıt</Button>
                          <span className="ml-auto text-xs">{post.type === 'business' ? '+10 Puan' : ''}</span>
                      </div>
                  </CardContent>
                </Card>
